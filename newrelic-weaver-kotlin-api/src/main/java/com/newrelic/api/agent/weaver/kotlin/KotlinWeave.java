...
/**
 * Marks a weave instrumentation class written in kotlin. Instructs the agent to weave a class into another class or set
 * of classes.
 * 
...
public @interface KotlinWeave {
    /**
     * The type of kotlin match. Defaults to an {@link KotlinMatchType#ExactClass} match.
     */
    KotlinMatchType type() default KotlinMatchType.ExactClass;
